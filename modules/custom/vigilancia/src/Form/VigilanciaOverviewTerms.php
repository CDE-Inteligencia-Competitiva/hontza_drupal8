...
namespace Drupal\vigilancia\Form;
 ...
 */
/*intelsat-2016
Hemos hecho un copy-paste desde el modulo taxonomy, concretamente desde Form/OverviewTerms,
para luego ir cambiando cosas*/
class VigilanciaOverviewTerms extends FormBase {
...
estrategia.node.add.despliegue        );
      ...
      $edit_url=\Drupal\Core\Url::fromUserInput('/group/'.$gid.'/taxonomy/term/'.$term->id().'/edit');
      $operations = array(
        'edit' => array(
          'title' => $this->t('Edit'),
          'query' => $destination,
